...
import { adminEditProductSchema as formSchema, ProductWithRelations } from "@/types/admin.product.types";
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input type="file" accept="image/*" onChange={e => handleImageUpload(e.target.files)} multiple />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
